...
<div class="d-flex justify-content-center align-items-center" style="height:120vh;">
    <div class="card p-2 bg-body-secondary bg-opacity-75 border border-dark border-2 rounded" style="width: 45rem;">
        <div class="card-body">
            <h3 class="card-title fs-1 text-center fw-semibold text-dark text-uppercase"><b>Cloth Update Form</b></h3>
            <br>
            <form action="<%= request.getContextPath() %>/updateClothInfo" method="post">
                <input type="number" hidden="hidden" id="id" name="clothId" value="${clothInfo.clothId}">
                <div class="mb-3">
                    <label for="clothName" class="form-label fs-5 fw-bold">Cloth Name <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" id="clothName" name="clothName" onblur="validateClothName();enableSubmit();" readonly="readonly" value="${clothInfo.clothName}" placeholder="Enter cloth name">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="brandName" name="brandName" onblur="validateBrandName();enableSubmit();" value="${clothInfo.brandName}"  placeholder="Enter brand name">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="categoryName" name="categoryName" onblur="validateCategoryName();enableSubmit();" value="${clothInfo.categoryName}"  placeholder="Enter category name">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="size" name="size" onblur="validateSize();enableSubmit();" value="${clothInfo.size}"  placeholder="Enter cloth size">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="color" name="color" onblur="validateColor();enableSubmit();" value="${clothInfo.color}"  placeholder="Enter cloth color">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="price" name="price" onblur="validatePrice();enableSubmit();" value="${clothInfo.price}"  placeholder="Enter cloth price">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="stockQuantity" name="stockQuantity" onblur="validateStockQuantity();enableSubmit();" value="${clothInfo.stockQuantity}"  placeholder="Enter stock Quantity">
                ...
                <div class="col-md-12">
                    ...
                    <select id="availabilityStatus" name="availabilityStatus" class="form-select" onblur="validateAvailabilityStatus();enableSubmit();">
                        ...
                        <option value="Available" ${clothInfo.availabilityStatus == 'Available' ? 'selected' : ''}>Available</option>
                        <option value="Limited Stock"  ${clothInfo.availabilityStatus == 'Limited Stock' ? 'selected' : ''}>Limited Stock</option>
                        <option value="Out Of Stock"  ${clothInfo.availabilityStatus == 'Out Of Stock' ? 'selected' : ''}>Out Of Stock</option>
                ...
                <br>
                <button type="submit" class="btn btn-primary rounded mx-auto d-block fs-4 fw-semibold"  disabled id="registerBtn">Update</button>

            </form>
            <h5 class="card-title text-center fs-3"  style="color:red;">${errorMsg}</h5>
            <h5 class="card-title text-center fs-3"  style="color:green;">${successMsg}</h5>
        </div>
    </div>
</div>
